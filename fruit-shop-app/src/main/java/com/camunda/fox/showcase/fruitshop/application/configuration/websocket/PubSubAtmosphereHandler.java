package com.camunda.fox.showcase.fruitshop.application.configuration.websocket;
...
public class PubSubAtmosphereHandler extends AbstractReflectorAtmosphereHandler {
  ...
  public void onRequest(AtmosphereResource event) throws IOException {
    ...
    if ("GET".equalsIgnoreCase(method)) {
      ...
      if (atmoTransport != null && !atmoTransport.isEmpty() && atmoTransport.equalsIgnoreCase(HeaderConfig.LONG_POLLING_TRANSPORT)) {
